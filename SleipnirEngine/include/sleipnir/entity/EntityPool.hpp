...
#ifndef SLEIPNIR_ENTITY_ENTITY_POOL_HPP
#define SLEIPNIR_ENTITY_ENTITY_POOL_HPP
...
/** @brief  Generates, holds and deletes entity ids
 *
 *  Deleted entities are reclaimed for future generations
 */
class EntityPool
{
public:
    //! Shortcut to collection of entity ids
...
#endif // SLEIPNIR_ENTITY_ENTITY_POOL_HPP
